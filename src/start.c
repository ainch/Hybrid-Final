...
void InputFileMake(){
   ...
   //----GPU_Device_Number----//
   //-------------------------//
   json_object_set_value(rootObject, "GPU_Device_Number", json_value_init_object());
   SubObject1 = json_object_get_object(rootObject,"GPU_Device_Number");
   json_object_set_number(SubObject1, "GPUDevice", device_num);
   //-------------------------//
   //--------Geometry---------//
   //-------------------------//
   json_object_set_value(rootObject, "Geometry", json_value_init_object());
   SubObject1 = json_object_get_object(rootObject,"Geometry");
   json_object_set_value(SubObject1, "SystemSpec", json_value_init_object());
   SubObject2 = json_object_get_object(SubObject1,"SystemSpec");
   json_object_set_number(SubObject2, "X_length(m)", xlength);
   json_object_set_number(SubObject2, "Y_length(m)", ylength);
   json_object_set_number(SubObject2, "Z_length(m)", zlength);
   json_object_set_number(SubObject2, "NumGridx", ngx);
   json_object_set_number(SubObject2, "NumGridy", ngy);

   json_object_set_value(SubObject1, "BoundaryCondition", json_value_init_object());
   SubObject2 = json_object_get_object(SubObject1,"BoundaryCondition");
   json_object_set_number(SubObject2, "Year", 2010);

   json_object_set_value(SubObject1, "ConductorSpec", json_value_init_object());
   SubObject2 = json_object_get_object(SubObject1,"ConductorSpec");
   json_object_set_number(SubObject2, "Year", 2010);

   json_object_set_value(SubObject1, "Source", json_value_init_object());
   SubObject2 = json_object_get_object(SubObject1,"Source");
   json_object_set_number(SubObject2, "Year", 2010);

   json_object_set_value(SubObject1, "DielectricSpec", json_value_init_object());
   SubObject2 = json_object_get_object(SubObject1,"DielectricSpec");
   json_object_set_number(SubObject2, "Year", 2010);


   json_object_set_value(rootObject, "GasSpecies", json_value_init_object());
   SubObject1 = json_object_get_object(rootObject,"GasSpecies");
   json_object_set_number(SubObject1, "Year", 2010);

   json_object_set_value(rootObject, "SimulationMethod", json_value_init_object());
   SubObject1 = json_object_get_object(rootObject,"SimulationMethod");
   json_object_set_number(SubObject1, "Year", 2010);

   json_object_set_value(rootObject, "Diagnostics", json_value_init_object());
   SubObject1 = json_object_get_object(rootObject,"Diagnostics");
   json_object_set_number(SubObject1, "Year", 2010);

   json_object_set_value(rootObject, "Collision_On_Off", json_value_init_object());
   SubObject1 = json_object_get_object(rootObject,"Collision_On_Off");
   json_object_set_number(SubObject1, "Year", 2010);
   ...
   sprintf(FileName, "New_%s", InputFile);
