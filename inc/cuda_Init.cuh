...
extern __global__ void MoveE(int Gsize,int ngy,float dt_dx,float dt_dy, Species *info, GCP *sp, GPG *data, GGA *Field);
#ifndef __CUDA_INIT_CUH__
#define __CUDA_INIT_CUH__
curandState *devStates;
int REDUCTION_GRID, SORT_GRID, MCC_GRID;
int REDUCTION_BLOCK, SORT_BLOCK,MCC_BLOCK;
int sMemSize;
